...
class Commands
{
	...
	public:
        ...
        {
            public:
                executeException(std::string msg, std::string line, std::list<std::string const> *errorList, int nbLine);
                executeException(std::string msg, std::list<std::string const> *errorList, int nbLine);
